angular.module('app', ['tasks-back'])
    .controller('main-controller', function ($scope, Widget) {
        ...
        $scope.editTask = function (taskId) {
            console.debug("Edit task with id:" + taskId);
        };

        $scope.completeTask = function (taskId) {
            console.debug("Complete task with id:" + taskId);
        };

        $scope.reopenTask = function (taskId) {
            console.debug("reopen task with id:" + taskId);
        };

        $scope.deleteTask = function (taskId) {
            console.debug("delete task with id:" + taskId);
        };

        $scope.setEditableTask = function (taskId) {
            console.debug("setEditableTask task with id:" + taskId);
